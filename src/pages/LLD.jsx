...
export default function ExampleProjectPage() {
  ...
  return (
    <>
    <div className="bg-[#4B0082] min-h-screen">
      {/* Hero Section */}
      <div className="relative min-h-screen leading-none">
        ...
        <div
          ...
          <p className="text-lg md:text-xl text-black font-bold max-w-2xl mx-auto">
            A brief description of what this project is about and its main purpose
          </p>
        </div>
        ...
        <div className="absolute top-[50vh] left-0 right-0 px-6 md:px-12 lg:px-24 z-10 flex justify-center">
          <div
            ...
            >
            <div className="relative mx-auto h-[130vh] w-full">
              <Image
                src="/Images/LLD.png"
      ...
      <div className="bg-[#4B0082] px-6 md:px-12 lg:px-24 py-16 relative z-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <p className="text-2xl text-white font-medium">December 2023</p>
            </div>
          </div>
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-wrap gap-3">
              {["C++", "LLD", "UML", "GOF Design Pattern", "Solid Design Pattern", "UML"].map((tech) => (
