        ...
        <>
          <div
            ...
            className={cx(
              ...
              'bg-[linear-gradient(to_right,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,rgba(f,f,f,f)_100%)]'
            )} />
          <div
            aria-hidden
            className={cx(
              ...
              'w-[clamp(24px,8%,120px)]',
              'bg-[linear-gradient(to_left,var(--logoloop-fadeColor,var(--logoloop-fadeColorAuto))_0%,rgba(f,f,f,f  )_100%)]'
            )} />
        </>
      )}
      <div
